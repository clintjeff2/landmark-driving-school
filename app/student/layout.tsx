...
// import { Car, Calendar, CreditCard, BookOpen, Award, Bell, AlertTriangle, FileText, LogOut, Menu } from "lucide-react"
...
//   const navigation = [
//     { name: "Dashboard", href: "/student/dashboard", icon: <Car className="h-5 w-5" />, color: "blue" },
//     { name: "Schedule", href: "/student/schedule", icon: <Calendar className="h-5 w-5" />, color: "green" },
//     { name: "Payments", href: "/student/payments", icon: <CreditCard className="h-5 w-5" />, color: "gold" },
//     { name: "Learning", href: "/student/learning", icon: <BookOpen className="h-5 w-5" />, color: "purple" },
//     { name: "Rewards", href: "/student/rewards", icon: <Award className="h-5 w-5" />, color: "gold" },
//     { name: "Alerts", href: "/student/alerts", icon: <AlertTriangle className="h-5 w-5" />, color: "orange" },
//     { name: "Documents", href: "/student/admission", icon: <FileText className="h-5 w-5" />, color: "indigo" },
//   ]

//   const getNavItemClass = (item: any, isActive: boolean) => {
//     const baseClass = "w-full justify-start transition-all duration-200 font-medium"
//     if (isActive) {
...
//             </Button>
//             <Link href="/student/dashboard" className="flex items-center gap-3 font-bold">
...
//                 <span className="text-white text-sm font-semibold">{user?.name?.charAt(0) || "S"}</span>
//               </div>
//             </div>
//             <Button
//               variant="outline"
...
//                 >
//                   <span className={`mr-3 ${pathname === item.href ? "text-white" : `text-${item.color}-500`}`}>
//                     {item.icon}
//                   </span>
//                   {item.name}
//                 </Button>
