...
import { Calendar, CreditCard, BookOpen, Award, AlertTriangle, FileText, TrendingUp, Clock } from "lucide-react"
      ...
      <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 rounded-2xl p-8 text-white">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            ...
            <p className="text-blue-100 text-lg">Your learning journey continues. Let's make today count!</p>
          </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-800">{schedules.length > 0 ? "Today" : "None"}</p>
              </div>
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="card-hover border-0 shadow-lg">
          ...
          <CardContent className="space-y-4">
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      <p className="font-semibold text-blue-800">{new Date(schedule.date).toLocaleDateString()}</p>
                      <p className="text-sm text-blue-600">{schedule.time_slot}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs text-blue-600">Instructor</p>
                      <p className="text-sm font-medium text-blue-800">{schedule.instructor_name}</p>
                    </div>
                  </div>
                </div>
              ))
            ...
            <Button asChild className="w-full gradient-blue text-white hover:opacity-90 btn-animate">
            ...
            {payments.length > 0 ? (
              <div className="p-4 rounded-xl bg-gradient-to-r from-green-50 to-green-100 border border-green-200">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-lg font-bold text-green-800">${payments[0].amount}</span>
                </div>
        ...
        <Card className="card-hover border-0 shadow-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200">
              <p className="text-sm text-purple-700 font-medium">Next: Traffic Signs & Signals</p>
              <p className="text-xs text-purple-600 mt-1">Estimated time: 25 minutes</p>
            </div>
            <Button
              asChild
        ...
        <Card className="card-hover border-0 shadow-lg">
          ...
          <CardContent className="space-y-4">
            <div className="text-center py-4">
              <div className="text-4xl font-bold gradient-gold bg-clip-text text-transparent mb-2">1,250</div>
              <p className="text-gray-600">Total Points Earned</p>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Next Reward</span>
                <span className="font-medium text-gold-600">250 points away</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="gradient-gold h-2 rounded-full" style={{ width: "83%" }}></div>
              </div>
            </div>
            <Button
              asChild
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-green-50 to-green-100 border border-green-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-600">Road conditions are excellent today</p>
                </div>
              </div>
            </div>
            <p className="text-xs text-gray-500">Last updated: Today, 8:00 AM</p>
            <Button
              asChild
              variant="outline"
          ...
          <CardContent className="space-y-4">
            <div className="p-4 rounded-xl bg-gradient-to-r from-indigo-50 to-indigo-100 border border-indigo-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-indigo-800">Admission Certificate</p>
